...
;if("object"!=typeof e.beginScope||null===e.beginScope)throw (W("beginScope must be object"), K);F(e,e.begin,{key:"beginScope"}),e.begin=m(e.begin,{joinWith:""})}})(e),(e=>{
if(Array.isArray(e.end)){
if(e.skip||e.excludeEnd||e.returnEnd)throw (W("skip, excludeEnd, returnEnd not compatible with endScope: {}"), K)
;if("object"!=typeof e.endScope||null===e.endScope)throw (W("endScope must be object"), K);F(e,e.end,{key:"endScope"}),e.end=m(e.end,{joinWith:""})}})(e)}function V(e){
function t(t,n){
